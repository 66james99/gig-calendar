...
import type { EventType, EventTypeSortableColumn, SortDirection } from './types.js';
...
// State
export let eventTypesCache: EventType[] = [];
export let currentSort: { column: EventTypeSortableColumn, direction: SortDirection } = { column: 'Name', direction: 'asc' };
...
export function setCurrentSort(sort: { column: EventTypeSortableColumn, direction: SortDirection }) {
    currentSort = sort;
}
...
export async function init() {
    ...
    if (refreshBtn) refreshBtn.addEventListener('click', refreshEventTypes);
...
export function applyFilters(items: EventType[]): EventType[] {
...
export function sortEventTypes(items: EventType[]): EventType[] {
